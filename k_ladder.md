...
_2026-07-24 01:37 UTC · fair = vig-stripped consensus of the books posting each rung. NO projection model (backtest: corr 0.37, too weak to price K tails; and pricing a book's unique rung off a model just bets our own error). Only rungs >=2 books agree on can be flagged._
...
**Matthew Boyd**
  O5.5: DK -130 (1 book, no consensus)
...
**Trevor Rogers**
  O5.5: DK +118 (1 book, no consensus)
